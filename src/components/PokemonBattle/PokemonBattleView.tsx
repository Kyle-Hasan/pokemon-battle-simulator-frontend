...
export default function PokemonBattleView({ battle }: PokemonBattleViewProps) {
  ...
  }, [battle, setPlayerTeam, setEnemyTeam, setPlayerTrainerInfo, setEnemyTrainerInfo, setPlayerFreeSwitch, setEnemyFreeSwitch, setTurnNumber, setPlayerActivePokemon, setEnemyActivePokemon, setBattleId]);

  return (
    <div className='w-full flex justify-center align-center mt-32'>
    { battle &&  <>  <PokemonBattleBattleField />
